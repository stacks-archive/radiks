  ...
  _createClass(Model, null, [{
    ...
    value: function fetchList(selector, options = {}) {
      ...
      return Promise.resolve().then(function () {
        selector.radiksType = _this.name;
  ...
  _createClass(Model, [{
    ...
    value: function fetchSchema() {
      ...
      return Promise.resolve().then(function () {
        ...
        const url = `${_this2.constructor.apiServer}/radiks/models/${name}/schema`; // console.log(url);
      ...
      return new Promise((resolve, reject) => {
        ...
        return Promise.resolve().then(function () {
          ...
          return Promise.resolve().then(function () {
            ...
            const filePath = _this3.blockstackPath();
    ...
    value: function saveToDB(encrypted) {
      ...
      return Promise.resolve().then(function () {
        const filePath = _this4.blockstackPath();
    ...
    value: function fetch() {
      ...
      return Promise.resolve().then(function () {
        return _this5.db().get(_this5.id);
      }).then(function (_resp) {
        const attrs = _resp;
        _this5.attrs = (0, _merge.default)(attrs, _this5.attrs);

        _this5.decrypt();

        if (_this5.afterFetch) {
          return _this5.afterFetch();
        }
      }).then(function () {
        return _this5;
      });
